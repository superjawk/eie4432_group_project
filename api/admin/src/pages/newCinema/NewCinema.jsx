...
import { cinemaInputs } from "../../formSource";
import useFetch from "../../hooks/useFetch";
import "./newCinema.scss";
...
const NewCinema = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      await axiosInstance.post("/cinemas", newcinema);
    } catch (err) {
      console.log(err);
    }
  };
          ...
          <div className="right">
            <form>
              ...
              <div className="selectMovies">
                <label>Movies</label>
                <select id="movies" multiple onChange={handleSelect}>
                  {loading
                    ? "loading"
                    : data &&
                      data.map((movie) => (
